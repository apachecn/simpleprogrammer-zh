...
[mt=2](https://itunes.apple.com/us/podcast/js-party/id1209616598?mt=2)
...
[-init-python-people/id 981834425？mt=2](https://itunes.apple.com/us/podcast/podcast.-init-python-people/id981834425?mt=2)
*   剧集约翰上了
...
*   订阅网址
 ...
 |
| [Java 酒馆](http://javapubhouse.libsyn.com/) | 这个播客讲的是如何用 Java 编程；不是您的典型 system.out.println("Hello world ")，而是更像真实的问题，例如 O/R 设置、线程、在屏幕上显示某些组件或一般的故障排除提示和技巧。这种格式是以播客的形式，这样你就可以订阅它，然后带着它在上班的路上(或回家的路上)听它，并从中多学一点(或巩固你所知道的)。 |
| 

*   Description
    This podcast is about how to program in Java; Not your typical system.out.println("Hello world "), but more like real problems, such as O/R settings, threads, displaying certain components on the screen or general troubleshooting tips and tricks. This format is a podcast, you can subscribe to it, and then listen to it on your way to work (or home) to learn a little more from it (or consolidate what you know).
*   订阅网址
    [https://itunes。苹果。com/us/podcast/Java-pub-house/id 467641329？mt=2](https://itunes.apple.com/us/podcast/java-pub-house/id467641329?mt=2)

 |
| [非法论证](http://www.illegalargument.com/) | Greg、Mark 和 Richard 每周都聚在一起，讨论 Java 社区中感兴趣的事情。葛瑞格在 sim works([http://www.simworks.com](http://www.simworks.com))公司工作，专营手机软件。马克为 SecureMX 工作(www.smx.co.nz)。理查德在蓝色列车软件公司(【http://www.bluetrainsoftware.com】T2)工作 |
| 

*   Description
    Greg, Mark and Richard get together every week to talk about things of interest in the Java community. Greg works in SimWorks ( [http://www.simworks.com](http://www.simworks.com) ), specializing in mobile phone software. Mark works for SecureMX (www.smx.co.nz). Richard works for Blue Train Software ( [http://www.bluetrainsoftware.com](http://www.bluetrainsoftware.com) )
*   订阅网址
    [https://itunes。苹果。com/us/podcast/illicial-argument/id 318116151？mt=2](https://itunes.apple.com/us/podcast/illegal-argument/id318116151?mt=2)

 |
| vJUG | 来自虚拟 Java 用户组的 vJUG 音频记录 |
| 

*   Description
    vjug recording from virtual Java user group
*   订阅网址
    [https://itunes.apple.com/us/podcast/vjug/id977963286?mt=2](https://itunes.apple.com/us/podcast/vjug/id977963286?mt=2)

 |
| [企业 Java 新闻广播](http://www.jsfcentral.com/jsf-central/resources/enterprisejavanewscasts/) | 由 Kito D. Mann、Ian Hlavats 和 Daniel Hinojosa 主持的 Enterprise Java Newscast 是一个月度播客，涵盖了企业 Java 开发领域的最新头条新闻。 |
| 

*   Description
    Enterprise Java Newscast, hosted by Kito D. Mann, Ian Hlavats and Daniel Hinojosa, is a monthly podcast that covers the latest headlines in the field of enterprise Java development.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/enterprise-Java-news cast/id 464258008？mt=2](https://itunes.apple.com/us/podcast/enterprise-java-newscast/id464258008?mt=2)
...
| 播客标题 | 描述 |
| --- | --- |
| [Ruby on Rails 播客](http://5by5.tv/rubyonrails) | Ruby on Rails 播客，关于 Ruby on Rails、开源软件和编程职业的每周对话。凯尔·戴格尔主持。 |
| 

*   Describe [T0】 Ruby on Rails podcast, a weekly conversation about Ruby on Rails, open source software and programming career. Hosted by Kyle Dagul.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/ruby-on-rails-podcast/id 840890158？mt=2](https://itunes.apple.com/us/podcast/ruby-on-rails-podcast/id840890158?mt=2)

 |
| [红宝石盗贼](https://devchat.tv/ruby-rogues/) | Ruby Rogues 播客是一个关于编程、职业、社区和 Ruby 相关主题的小组讨论。我们每周发布一篇与著名程序员和 Rubyists 的对话，帮助程序员在职业和技能上取得进步。 |
| 

*   Description [T0】 Ruby Rogues Podcast is a group discussion about programming, career, community and Ruby-related topics. We publish a dialogue with famous programmers and Rubyists every week to help programmers make progress in their careers and skills.
*   Subscription URL
    [https://itunes.apple.com/us/podcast/the-ruby-rogues/id705335155? John talks about marketing yourself as a software developer in Episode 187](https://itunes.apple.com/us/podcast/the-ruby-rogues/id705335155?mt=2)

 |
| [RubyPlus 播客](https://rubyplus.com/podcasts) | RubyPlus.com 播客 |
| 

*   描述
    RubyPlus.com 播客
*   订阅网址
    [https://itunes。苹果。com/us/Podcast/ruby plus-Podcast/id 1097360722？mt=2](https://itunes.apple.com/us/podcast/rubyplus-podcast/id1097360722?mt=2)

 |
| [从这里开始:Ruby on Rails](http://starthere.fm/) | 你是一个需要指导的 Ruby on Rails 开发新手吗？好吧，从这里开始:Ruby on Rails 就是为你准备的节目！Dain Miller 是你的 Ruby on Rails 教练，他将提供洞察力和资源，帮助你从一无所知变成全职的 Ruby 忍者。每个人都从某处开始，而你从这里开始！ |
| 

*   Description
    Are you a novice Ruby on Rails developer who needs guidance? Well, start here: Ruby on Rails is the program for you! Dain Miller is your Ruby on Rails coach. He will provide insight and resources to help you go from ignorance to full-time Ruby ninja. Everyone starts somewhere, and you start here!
*   订阅网址
    [https://itunes。苹果。com/us/podcast/start-here-ruby-on-rails/id 987277709？mt=2](https://itunes.apple.com/us/podcast/start-here-ruby-on-rails/id987277709?mt=2)
...
| 播客标题 | 描述 |
| --- | --- |
| [认知角色](http://blog.cognitect.com/cognicast) | Cognitect，Inc .关于软件和软件开发者的播客。我们经常谈论 Clojure、ClojureScript、Datomic、敏捷软件开发、分布式系统、函数式编程，以及许多其他令人惊奇的东西。 |
| 

*   Describe
    Cognitect, Inc.' s podcast about software and software developers. We often talk about Clojure, ClojureScript, Datomic, agile software development, distributed systems, functional programming, and many other amazing things.
*   订阅网址
    [https://itunes。苹果。com/is/podcast/the-cogn ICAT-cogn itect-blog/id 498067022？mt=2](https://itunes.apple.com/is/podcast/the-cognicast-cognitect-blog/id498067022?mt=2)

 |
| [功能极客](http://www.functionalgeekery.com/) | 关于函数式编程的播客，涵盖多种语言的主题。 |
| 

*   Description
    A podcast about functional programming, covering topics in many languages.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/functional-geekery/id 790455326？mt=2](https://itunes.apple.com/us/podcast/functional-geekery/id790455326?mt=2)

 |
| [LambdaCast](http://soundcloud.com/lambda-cast) | LambdaCast 是一个关于面向在职开发人员的函数式编程的播客。我们的重点是用清晰的日常语言描述概念，而不冲淡任何东西。如果你曾经对 FP 感兴趣，但是被术语或者不熟悉的概念所拒绝，这里就是你要去的地方。 |
| 

*   Description
    Lambdacast is a podcast about functional programming for on-the-job developers. Our focus is to describe concepts in clear everyday language without diluting anything. If you have ever been interested in FP, but have been rejected by terms or unfamiliar concepts, this is the place to go.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/lambda cast/id 1133087254？mt=2](https://itunes.apple.com/us/podcast/lambdacast/id1133087254?mt=2)

 |
| [定义](https://soundcloud.com/defn-771544745) | 分享 Clojure、其生态系统和社区热情的播客。维贾伊·基兰和雷·麦克德莫特 |
| 

*   Description
    Podcasts share enthusiasm about Clojure, its ecosystem and community. Jay Kieran and Ray mcdermott
*   订阅网址
    [https://itunes.apple.com/is/podcast/defn/id1114899563?mt=2](https://itunes.apple.com/is/podcast/defn/id1114899563?mt=2)

 |
| [编程中断](http://www.programmingthrowdown.com/) | 试图在一系列编程和技术主题上教育计算机科学家和软件工程师。每个节目将涵盖一种新的编程语言，因此听众将能够明智地谈论任何编程语言。 |
| 

*   Description
    Programming Throwdown tries to educate computer scientists and software engineers on a series of programming and technical topics. Each program will cover a new programming language, so listeners will be able to talk about any programming language wisely.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/programming-throwdown/id 427166321？mt=2](https://itunes.apple.com/us/podcast/programming-throwdown/id427166321?mt=2)

 |
| [测试会谈](https://joecolantonio.com/testtalks/) | TestTalks 是由 Joe Colantonio 主持的每周播客，专门研究软件测试自动化的所有事情。TestTalks 涵盖了测试领域的新闻，评论了关于自动化的书籍，并与测试自动化领域的一些思想领袖进行了交谈。我们的目标是采访一些当今最成功和最鼓舞人心的软件工程师和测试自动化思想领袖。 |
| 

*   Description
    Test Talks is a weekly podcast hosted by Joe Colantonio, which specializes in software test automation. TestTalks covers news in the field of testing, reviews books on automation, and talks with some thought leaders in the field of test automation. Our goal is to interview some of the most successful and inspiring software engineers and test automation thought leaders today.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/test talks-自动化-牛逼 ness/id 826722706？mt=2](https://itunes.apple.com/us/podcast/testtalks-automation-awesomeness/id826722706?mt=2)
*   集约翰在
    第 36 集,讲我的软技能：软件开发人员的生活手册
    [http://Joe colantonio。com/test talks/36-John-sonmez-the-software-developers-life-manual](http://joecolantonio.com/testtalks/36-john-sonmez-the-software-developers-life-manual)
    第 3 集,讲的是用硒和个人品牌打造自动化测试框架. http://Joe colantonio。com/test talks/03-selenium-automation-framework/

 |
| [拉勒维尔新闻](https://laravel-news.com/podcast) | Laravel 新闻播客为您带来所有与 Laravel 相关的最新新闻和事件。本播客由埃里克·巴恩斯和杰克·弗鲁主持。 |
| 

*   Description
    La Levaire News Podcast brings you all the latest news and events related to La Levaire. This podcast is hosted by Eric Barnes and Jack Fru.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/laravel-news-podcast/id 1051289963？mt=2](https://itunes.apple.com/us/podcast/laravel-news-podcast/id1051289963?mt=2)

 |
| [Lara casts 片段](https://laracasts.simplecast.fm/) | Laracasts 片段，每一集，都提供了一个关于 web 开发某些方面的想法。不多不少。由杰弗里·韦主持。 |
| 

*   Description [T0】 Lara casts fragments, each episode, provide an idea about some aspect of web development. No more, no less. Hosted by Jeffrey Wei.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/the-Lara casts-snippet/id 1059530816？mt=2](https://itunes.apple.com/us/podcast/the-laracasts-snippet/id1059530816?mt=2)

 |
| [拉勒维尔播客](https://laravel.com/) | Laravel 播客为您带来 Laravel 和 PHP 开发新闻和讨论。该播客由 Matt Stauffer 主持，常客包括 Taylor ot well(Laravel 的创始人)和 Jeffrey Way(Laracasts 的创始人)。 |
| 

*   Description [T0】 Laravel Podcast brings you Laravel and PHP development news and discussion. The podcast is hosted by Matt Stauffer, and frequent visitors include Taylor Otwell (founder of Laravel) and Jeffrey Way (founder of Laracasts).
*   订阅网址
    [https://itunes。苹果。com/us/podcast/the-laravel-podcast/id 653204183？mt=2](https://itunes.apple.com/us/podcast/the-laravel-podcast/id653204183?mt=2)

 |
| [仙丹喷泉](http://feed.elixirfountain.com/) | 由@johnny_rugger 主持的@Elixirlang 社区的每周新闻和采访播客 RSS 源:[http://feed.elixirfountain.com](http://feed.elixirfountain.com) |
| 

*   Description
    Your weekly news podcast & comes from interviews hosted by @johnny_rugger in the @Elixirlang community. RSS feed: [http://feed.elixirfountain.com](http://feed.elixirfountain.com)
*   订阅网址
    [https://itunes。苹果。com/us/podcast/elixir-fountain/id 1039942918？mt=2](https://itunes.apple.com/us/podcast/elixir-fountain/id1039942918?mt=2)

 |
| [掌握嵌入式系统](http://embeddedsuccess.com/podcast/) | 我确定了掌握嵌入式系统的四个主要问题:1 .没有足够的专家；2.不适当的设计和不良的故障检测；3.强制性的多站点方法正在失败；4.管理虚拟团队的严重错误。我会教你克服这些挑战的诀窍和工具。 |
| 

*   Description
    I have identified four major problems in mastering embedded systems: 1\. There are not enough experts; 2\. Inappropriate design and poor fault detection; 3\. The mandatory multi-site method is failing; 4\. Serious mistakes in managing virtual teams. I will teach you the tricks and tools to overcome these challenges.
*   订阅网址
    [https://itunes。苹果。com/de/播客/mastering-embedded-systems/id 1015304945？l = en](https://itunes.apple.com/de/podcast/mastering-embedded-systems/id1015304945?l=en) T8

 |
| [出发时间](https://changelog.com/gotime) | 每周一次的专题小组播客，讨论 Go 编程语言、社区以及两者之间的一切。 |
| 

*   Describe
    weekly podcast of group members, discussing Go programming language, community and everything in between.
*   订阅网址
    [https://itunes.apple.com/us/podcast/go-time/id1120964487](https://itunes.apple.com/us/podcast/go-time/id1120964487)

 |
| 哈斯克尔剧组 | 收听 Haskell 社区的定期采访。播客包括新闻、图书馆以及我们和客人聊的任何其他话题。 |
| 

*   Description
    Listen to regular interviews with Haskell community. Including podcasts, news, libraries and any other topics we chat with our guests.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/the-haskell-cast/id 694047404？mt=2](https://itunes.apple.com/us/podcast/the-haskell-cast/id694047404?mt=2)

 |
| [榆树镇](https://elmtown.github.io/) | 一个关于制作和使用 Elm 语言的人以及他们所做的事情的播客。 |
| 

*   Describe
    a podcast about people who make and use elm language and what they do.

[mt=2](https://itunes.apple.com/us/podcast/elm-town/id1158047037?mt=2)

 |
| [会说话的科特林](http://talkingkotlin.com/) | 一个双月播客，涵盖 JetBrains 的 Kotlin 编程语言以及相关技术。由哈迪·哈里里主持 |
| 

*   Description
    This is a bimonthly podcast, which covers JetBrains' Kotlin programming language and related technologies. By Hadi Hariri
*   主持订阅网址
    [https://itunes。苹果。com/us/podcast/talking-kot Lin/id 1194631266？mt=2](https://itunes.apple.com/us/podcast/talking-kotlin/id1194631266?mt=2)
...
| 播客标题 | 描述 |
| --- | --- |
| [偏导数](http://partiallyderivative.com/) | 我们周围世界的日常数据，由数据科学超级极客主持。对于书呆子和好奇的书呆子。 |
| 

*   Describe
    the daily data of the world around us, hosted by data science super geeks. For nerds and curious nerds.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/偏导数/id 942048597？mt=2](https://itunes.apple.com/us/podcast/partially-derivative/id942048597?mt=2)

 |
| [数据怀疑论者](http://dataskeptic.com/) | “数据怀疑论者”播客的特点是采访和讨论与数据科学、统计学、机器学习、人工智能等相关的主题，所有这些都是从应用批判性思维和科学方法的角度来评估主张的真实性和方法的有效性。 |
| 

*   Description
    The feature of data skepticism podcast is to interview and discuss topics related to data science, statistics, machine learning, artificial intelligence, etc., all of which evaluate the accuracy of claims and the effectiveness of methods from the perspective of applying critical thinking and scientific methods.
*   订阅网址
    [https://itunes。苹果。com/us/播客/数据-怀疑论者/id890348705？mt=2](https://itunes.apple.com/us/podcast/data-skeptic/id890348705?mt=2)

 |
| [线性题外话](http://lineardigressions.com/) | 在每一集里，你的主持人通过有趣的(通常是非常不寻常的)应用探索机器学习和数据科学。 |
| 

*   Description
    In each episode, your host explores machine learning and data science through interesting (and often very unusual) applications.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/linear-decade tions/id 941219323？mt=2](https://itunes.apple.com/us/podcast/linear-digressions/id941219323?mt=2)

 |
| [奥莱利数据显示](https://www.oreilly.com/topics/data) | 奥莱利数据展探索了推动大数据、数据科学和人工智能的机遇和技术。通过采访和分析，我们突出了将数据投入工作的人。 |
| 

*   Description
    O 'Reilly Data Exhibition explores opportunities and technologies to promote big data, data science and artificial intelligence. Through interviews and analysis, we highlighted the people who put data to work.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/oreilly-data-show-oreilly/id 944929220？mt=2](https://itunes.apple.com/us/podcast/oreilly-data-show-oreilly/id944929220?mt=2)

 |
| [学习机 101](http://www.learningmachines101.com/) | 基于人工智能和机器学习原理的智能机器现在在我们的日常生活中很普遍。在本播客系列中，我们将探讨以下问题:这些设备是如何工作的？他们从哪里来？我们怎样才能让它们变得更聪明，更像人类？ |
| 

*   Description
    Intelligent machines based on artificial intelligence and machine learning principles are now ubiquitous in our daily life. In this podcast series, we will explore the following questions: How do these devices work? Where do they come from? How can we make them smarter and more human?
*   订阅网址
    [https://itunes。苹果。com/us/podcast/learning-machines-101/id 892779679？mt=2](https://itunes.apple.com/us/podcast/learning-machines-101/id892779679?mt=2)

 |
| [数据故事](http://datastori.es/) | Enrico Bertini 和 Moritz Stefaner 讨论了数据分析、可视化和相关主题的最新发展。 |
| 

*   Describe
    Enrico Bertini and Moritz Stefaner discuss the latest development of data analysis, visualization and related topics.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/data-stories/id 502854960？mt=2](https://itunes.apple.com/us/podcast/data-stories/id502854960?mt=2)

 |
| [说话的机器](http://www.thetalkingmachines.com/blog/) | 会说话的机器是你进入机器学习世界的窗口。你的主持人，凯瑟琳·戈尔曼和瑞恩·亚当斯，为你带来了与该领域专家的清晰对话，对行业新闻的深刻讨论，以及对你的问题的有用回答。机器学习正在改变我们可以对周围世界提出的问题，在这里我们探索如何提出最好的问题以及如何处理答案。 |
| 

*   Description
    The talking machine is your window into the machine learning world. Your hosts, Catherine Gorman and Ryan Adams, have brought you a clear dialogue with experts in this field, a profound discussion of industry news, and useful answers to your questions. Machine learning is changing the questions we can ask the world around us. Here we explore how to ask the best questions and how to deal with the answers.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/talking-machines/id 955198749？mt=2](https://itunes.apple.com/us/podcast/talking-machines/id955198749?mt=2)

 |
| [本周在机器学习& AI](https://twimlai.com/) | 本周《机器学习&人工智能》为你带来了本周来自机器学习和人工智能世界的最有趣和最重要的故事。我们讨论研究、技术和商业的最新发展，并在网上探索有趣的项目。涵盖的技术包括:机器学习、人工智能、深度学习、自然语言处理、神经网络、分析、大数据等。 |
| 

*   Description
    Machine learning this week & AI brings you the most interesting and important stories in the field of machine learning and artificial intelligence this week. We discuss the latest developments in research, technology and business, and explore interesting projects online. Covered technologies include: machine learning, artificial intelligence, deep learning, natural language processing, neural network, analysis, big data, etc.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/this-week-in-machine-learning-ai-podcast/id 1116303051？mt=2](https://itunes.apple.com/us/podcast/this-week-in-machine-learning-ai-podcast/id1116303051?mt=2)
...
| 播客标题 | 描述 |
| --- | --- |
| [人类的敏捷](http://ryanripley.com/agile-for-humans/) | 致力于让敏捷工作的个人和互动的每周播客。我的目标是帮助你创造一个安全和协作的工作环境，在这个环境中，人们被授权做他们最好的工作。 |
| 

*   Description
    This is a weekly podcast dedicated to making agile work personal and interactive. My goal is to help you create a safe and collaborative working environment where people are empowered to do their best work.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/agile-for-humans-podcast-diving/id 991671232？mt=2](https://itunes.apple.com/us/podcast/agile-for-humans-podcast-devoted/id991671232?mt=2)

 |
| [敏捷咖啡播客](http://agilecoffee.com/) | AgileCoffee 聚集了一群对敏捷方法和精益实践充满热情的从业者。我们的模式模仿了精益咖啡模式，即结构化、无议程的会议，敏捷者(或好奇的旁观者)聚在一起交流想法。 |
| 

*   Description
    Agile Coffee gathers a group of practitioners who are passionate about agile methods and lean practices. Our model imitates the lean coffee model, that is, structured, agenda-free meetings, where agile people (or curious bystanders) get together to exchange ideas.
*   订阅网址
    [https://itunes。苹果。com/us/播客/the-agile-coffee-podcast/id 880524138？mt=2](https://itunes.apple.com/us/podcast/the-agile-coffee-podcast/id880524138?mt=2)

 |
| [这种敏捷的生活](http://www.thisagilelife.com/) | 敏捷软件开发是最佳实践和哲学租户的混合。但是理想情况和开发者在现实世界中面临的情况有很大的不同。《敏捷生活》采访了一些业界精英，讨论了软件工程的挑战，以及现实世界的解决方案如何将敏捷方法的承诺带到您的软件项目中。 |
| 

*   Description
    Agile software development is a combination of best practices and philosophical tenants. But the ideal situation is very different from what developers face in the real world. Agile Life interviewed some industry elites to discuss the challenges of software engineering and how real-world solutions can bring the promise of agile methods to your software projects.
*   订阅网址
    [https://itunes。苹果。com/us/播客/this-agile-life/id 549367028？mt=2](https://itunes.apple.com/us/podcast/this-agile-life/id549367028?mt=2)

 |
| [敏捷革命](https://theagilerevolution.com/) | 加入克雷格·史密斯、托尼·庞顿和蕾妮·特劳顿的敏捷世界之旅，他们会浏览与敏捷相关的最新博客，调查实践和技术，查看工具，回答您的问题，并与敏捷社区中的创意者交流。革命者不仅关注敏捷，因为它与软件开发有关，而且关注它如何应用于业务、过渡、文化、人员以及更多！ |
| 

*   Description
    Join craig smith, Tony Pandon, and Renee Troughton in the agile world tour. They will browse the latest blogs related to agile, investigate practices and technologies, check tools, answer your questions, and communicate with creatives in the agile community. Revolutionaries not only pay attention to Agile because it is related to software development, but also how it is applied to business, transition, culture, people and more!
*   订阅网址
    [https://itunes。苹果。com/us/播客/the-agile-revolution/id 451966819？mt=2](https://itunes.apple.com/us/podcast/the-agile-revolution/id451966819?mt=2)

 |
| [Scrum Master 工具箱播客](http://www.scrum-master-toolbox.com/) | Scrum Master Toolbox Podcast:敏捷和精益 Podcast，给你提示和技巧来提高你作为 Scrum Master 的技能。聆听每天与来自世界各地的 Scrum 大师进行的鼓舞人心的对话。加入 Vasco Duarte，他将采访客人，为你提供如何成为一名有效的 Scrum 大师的最新和最好的建议。 |
| 

*   Description
    Scrum Master Toolbox Podcast: Agile and Lean Podcast, giving you tips and tricks to improve your skills as a Scrum Master. Listen to inspiring conversations with Scrum masters from all over the world every day. Join Vasco Duarte, who will interview guests and provide you with the latest and best advice on how to become an effective Scrum master.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/scrum-master-toolbox-podcast/id 963592988？mt=2](https://itunes.apple.com/us/podcast/scrum-master-toolbox-podcast/id963592988?mt=2)

 |
| [敏捷 3 分钟](https://agilein3minut.es/archive/) | 可能行得通的最简单的播客。 |
| 

*   Describe the simplest podcast that
    might work.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/agile-in-3 分钟/id 1043107219？mt=2](https://itunes.apple.com/us/podcast/agile-in-3-minutes/id1043107219?mt=2)

 |
| [敏捷回答](https://weisbart.com/) | 关于 Scrum 框架、敏捷软件开发和敏捷管理的可行建议。亚当并不满足于在象牙塔里给出假设性的建议，他还接听了那些与现实世界中的问题作斗争的人们的电话。利用他多年的经验，他提供了简明的，一步一步的指导，给你新的工具来征服你的挑战。 |
| 

*   Describe
    feasible suggestions on Scrum framework, agile software development and agile management. Adam is not satisfied with giving hypothetical advice in the ivory tower. He also takes phone calls from people who struggle with problems in the real world. Using his years of experience, he provides concise, step-by-step guidance and gives you new tools to conquer your challenges.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/agile-answers/id 1037924282？mt=2](https://itunes.apple.com/us/podcast/agile-answers/id1037924282?mt=2)
...
| 播客标题 | 描述 |
| --- | --- |
| [DevOps 咖啡馆](http://devopscafe.org/) | 在这个访谈节目中，约翰·威利斯和达蒙·爱德华兹务实地看待新兴的 DevOps 运动背后的技术、工具和业务发展。 |
| 

*   Description
    In this talk show, John Willis and Damon Edwards pragmatically look at the technology, tools and business development behind the emerging DevOps movement.
*   订阅网址
    [https://itunes。苹果。com/us/播客/devo PS-cafe-podcast/id 371931111？mt=2](https://itunes.apple.com/us/podcast/devops-cafe-podcast/id371931111?mt=2)

 |
| [美食对抗秀](http://foodfightshow.org/) | DevOps 厨师们战斗的播客 |
| 

*   A podcast describing Chef DevOps's battle

*   订阅网址
    [https://itunes。苹果。com/us/Podcast/The-food-fight-show/id 495577922？mt=2](https://itunes.apple.com/us/podcast/the-food-fight-show/id495577922?mt=2)

 |
| [PowerScripting 播客](https://powershell.org/podcast/) | PowerScripting 播客是为学习 Windows PowerShell 的人准备的。在每一集里，我们都会为您带来关于 Windows PowerShell 的新闻、采访和资源，以帮助您学习。我们还为您带来我发现的提示、技巧、一行程序和陷阱，以及听众提交的内容。 |
| 

*   Description
    PowerScripting podcast is for people learning Windows PowerShell. In each episode, we will bring you news, interviews and resources about Windows PowerShell to help you learn. We also bring you tips, tricks, one-line procedures and traps that I found, as well as the content submitted by listeners.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/power scripting-podcast/id 256074147？mt=2](https://itunes.apple.com/us/podcast/powerscripting-podcast/id256074147?mt=2)
...
*   订阅网址
 ...
 |
| [被捕的 DevOps](https://www.arresteddevops.com/) | 《被捕的 DevOps》由马特·斯特拉顿、特雷弗·赫斯和布里奇特·克罗姆胡特主持。ADO 是一个播客，可以帮助你理解，发展良好的实践，并操作你的团队和组织，以获得最大的 DevOps。 |
| 

*   Description
    The arrested DevOps are hosted by Matt stratton, Trevor Hess and Bridget krom Huth. ADO is a podcast that can help you understand, develop good practices, and operate your team and organization to get the maximum DevOps.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/arrested-devo PS/id 773888088？mt=2](https://itunes.apple.com/us/podcast/arrested-devops/id773888088?mt=2)

 |
| [木偶播客](https://puppet.com/podcasts) | 木偶播客的特色是木偶社区成员谈论配置管理和云自动化以及 DevOps 文化的最新趋势。 |
| 

*   Description
    Puppet podcast features members of puppet community talking about the latest trend of configuration management & Cloud automation and DevOps culture.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/puppet-podcast/id 546792095？mt=2](https://itunes.apple.com/us/podcast/puppet-podcast/id546792095?mt=2)
...
| 播客标题 | 描述 |
| --- | --- |
| [云播(。net)](http://www.thecloudcast.net/) | Aaron Delp 和 Brian Gracely 主持这个获奖的每周播客，讨论推动当今数据中心和云计算融合的技术和组织变革。主题包括云计算&#124; AWS &#124; Azure &#124; GCP &#124;无服务器&#124; DevOps &#124; AppDev &#124; SaaS &#124;物联网。嘉宾都是行业思想领袖和改变 IT 行业的公司领袖。 |
| 

*   Description
    Aaron Delp and Brian Gracely host this award-winning weekly podcast to discuss the technological and organizational changes that are driving the convergence of today's data centers and cloud computing. Including cloud computing &#124; AWS &#124; Azure &#124; GCP &#124; Serverless &#124; DevOps &#124; AppDev &#124; SaaS &#124; Internet of Things. The guests are industry thought leaders and company leaders who have changed the IT industry.

[net-weekly-cloud/id417826820？mt=2](https://itunes.apple.com/us/podcast/cloudcast-.net-weekly-cloud/id417826820?mt=2)

 |
| [云计算每周播客](http://www.cloudtp.com/) | 由云计算专家 David Linthicum 主持，这个播客是对云计算世界的一个非炒作的观察。本播客讨论了新内容、正在发挥作用的内容，并邀请了专家嘉宾为您提供在云计算中取得成功所需的建议。 |
| 由云计算专家大卫·林西库姆主持，这个播客是对云计算世界的一个不夸张的介绍。本播客讨论了新内容、正在发挥作用的内容，并邀请了专家嘉宾为您提供在云计算中取得成功所需的建议。*   订阅网址
    [https://itunes。苹果。com/us/podcast/云计算-每周-podcast/id 641566140？mt=2](https://itunes.apple.com/us/podcast/cloud-computing-weekly-podcast/id641566140?mt=2) |
| [微软云秀](http://www.microsoftcloudshow.com/podcast) | 安德鲁·康奈尔和克里斯·约翰森聚在一起，从开发人员的角度分享他们对微软云技术(包括 Microsoft Azure、Office 365 和 SharePoint)的最新新闻、笔记、评论和听众问题的见解和经验。 |
| 

*   Description
    Andrew Cornell and Chris Johnson get together to share their views and experiences on the latest news, notes, comments and audience questions of Microsoft cloud technologies including Microsoft Azure, Office 365 and SharePoint from the perspective of developers.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/Microsoft-cloud-show/id 731565415？mt=2](https://itunes.apple.com/us/podcast/microsoft-cloud-show/id731565415?mt=2)

 |
| [Office 365 开发者播客](http://blogs.office.com/) | 唯一一场专注于 Office 365 开发的展览，我们与来自全球各地的 Office 365 平台编码专家进行了交流。有关 Office 365 开发的更多信息，请访问 dev.office.com 并关注我们的@OfficeDev。 |
| 

*   Description
    This is the only exhibition that focuses on the development of Office 365\. Here, we communicate with Office 365 platform coding experts from all over the world. For more information about the development of Office 365, please visit dev.office.com and follow our @OfficeDev.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/office-365-developer-podcast/id 886295635？mt=2](https://itunes.apple.com/us/podcast/office-365-developer-podcast/id886295635?mt=2)

 |
| [微软 Azure 云封面秀](https://channel9.msdn.com/Shows/Cloud+Cover) | 微软 Azure Cloud Cover 是你在微软云上的眼睛。加入克里斯·里斯纳和·白，他们将介绍 Microsoft Azure，演示其功能，讨论最新的新闻和公告，并分享技巧和诀窍。 |
| 

*   Description
    Microsoft Azure Cloud Cover is the Microsoft Cloud in your eyes. Join Chris Riesner and Bai who will introduce Microsoft Azure, demonstrate its features, discuss the latest news and announcements, and share tips and tricks.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/Microsoft-azure-cloud-cover/id 417256457？mt=2](https://itunes.apple.com/us/podcast/microsoft-azure-cloud-cover/id417256457?mt=2)

 |
| [蔚蓝星期二和科里](https://channel9.msdn.com/Shows/Tuesdays-With-Corey) | Corey Sanders 回答您关于 Microsoft Azure 的问题——虚拟机、网站、移动服务、开发/测试等。如果你有问题，科里会找到答案的！Corey Sanders 是微软 Azure 计算团队的项目管理总监。 |
| 

*   Description
    corey sanders answers your questions about Microsoft Azure-virtual machines, websites, mobile services, development/testing, etc. If you have a question, Corey will find the answer! Corey Sanders is the project management director of Microsoft Azure Computing Team.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/azure-Tuesdays-with-corey/id 1023243001？mt=2](https://itunes.apple.com/us/podcast/azure-tuesdays-with-corey/id1023243001?mt=2)

 |
| [Azure 播客](http://azpodcast.azurewebsites.net/) | Cale Teeter、Evan Basilik 和 Sujit D'Mello 在微软担任云计算和服务领域的顾问。他们专注于构建利用云的企业应用和服务。 |
| 

*   Description
    Kyle Teeter, Evan Baslick & Sujit de Mello works as a consultant in cloud computing and services at Microsoft. They focus on building enterprise applications and services that utilize the cloud.
*   订阅网址
    [https://itunes。苹果。com/us/播客/the-azure-podcast/id 728193635？mt=2](https://itunes.apple.com/us/podcast/the-azure-podcast/id728193635?mt=2)

 |
| [蔚蓝的星期五](http://s.ch9.ms/Shows/Azure-Friday) | Scott Hanselman 与构建 Azure 的实际工程师坐在一起，学习如何对云进行编程。没有营销，没有废话，只有两个工程师和一台笔记本电脑。在[http://Friday.Azure.com](http://Friday.Azure.com)加入对话 |
| 

*   Description
    Scott Hanselman sat with the actual engineers who built Azure and learned how to program the cloud. No marketing, no nonsense, just two engineers and a laptop. In [http://Friday.Azure.com](http://Friday.Azure.com)
*   加入对话订阅网址
    [https://itunes。苹果。com/us/podcast/azure-Friday-HD-channel-9/id 739501868？mt=2](https://itunes.apple.com/us/podcast/azure-friday-hd-channel-9/id739501868?mt=2)

 |
| [代码覆盖率](http://www.codecoverage.org/) | 两周一次的播客，开发者使用 Salesforce 和 Salesforce1 的所有功能。尤其是 force.com(Apex，Visualforce)，还有 Heroku 和 ExactTarget。 |
| 

*   Describe
    a bi-weekly podcast in which developers work with Salesforce and Salesforce1\. Especially force.com(Apex, Visualforce), Heroku and ExactTarget.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/code-coverage-sales force-developer/id 880831007？mt=2](https://itunes.apple.com/us/podcast/code-coverage-salesforce-developer/id880831007?mt=2)

 |
| [销售力量管理播客](https://admin.salesforce.com/) | Salesforce Admins 播客揭示了真正的 Salesforce Admins 如何通过点击而不是代码来解决问题。这是一个每周 20 分钟的播客，由 Mike Gerholdt 和 Gillian Bruce 主持，采用脱口秀形式，与才华横溢的 Salesforce 管理员一起通过实施企业 CRM 解决方案来解决云中的实际问题，并从中获得乐趣。 |
| 

*   Description [T0】 sales force Admins podcast lets real Salesforce Admins solve problems by clicking instead of code. This is a weekly 20-minute podcast, hosted by Mike Gerholdt and Gillian Bruce. It takes the form of talk show, and has fun with the talented Salesforce administrators by implementing enterprise CRM solutions to solve practical problems in the cloud.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/button click-admin-podcast/id 914088438？mt=2](https://itunes.apple.com/us/podcast/buttonclick-admin-podcast/id914088438?mt=2)

 |
| 你好，先生！显示 | 你好，先生！Show 是每周一次的技术和软件开发播客，重点关注 Salesforce 平台。让开发人员和非开发人员了解我们独特的休闲、诚实和有趣的评论。 |
| 

*   Description
    Good day, sir! Show is a weekly podcast on technology and software development, focusing on the Salesforce platform. Let developers and non-developers know about our unique casual, honest and interesting comments.

[-show-salesforce/id732617888？mt=2](https://itunes.apple.com/us/podcast/good-day-sir!-show-salesforce/id732617888?mt=2)

 |
| [云焦点周刊](http://www.cloudfocusweekly.com/) | 涵盖最新云计算新闻、Salesforce.com 事件和活动的每周节目。如果它发生在云中，我们会关注它。不要错过每个节目结束时的 CloudFocus 应用程序周精选。 |
| 

*   Describe
    a weekly program covering the latest news, events and events of cloud computing in Salesforce.com. If it happens in the cloud, we will pay attention to it. Don't miss the CloudFocus App Week selection at the end of each program.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/cloud focus-weekly/id 382867624？mt=2](https://itunes.apple.com/us/podcast/cloudfocus-weekly/id382867624?mt=2)

 |
| [用科技话说](http://speakingintech.com/) | 用科技术语来说:“企业科技与消费者科技相遇的地方…”。《科技演讲》由 Greg Knieriemen、Ed Saipetch 和 Sarah Vela 主持。主题包括热门技术、数据存储、云计算、网络、存储虚拟化、服务器虚拟化、备份、灾难恢复和技术世界中任何其他有趣的事情。 |
| 

*   Description
    In the words of science and technology: "The place where enterprise technology meets consumer technology …". Science and Technology Lecture is hosted by Greg Knieriemen, Ed Saipetch and Sarah Vela. Topics include hot technologies, data storage, cloud computing, networking, storage virtualization, server virtualization, backup, disaster recovery and any other interesting things in the technological world.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/speaking-in-tech/id 469061956？mt=2](https://itunes.apple.com/us/podcast/speaking-in-tech/id469061956?mt=2)

 |
| [托德·克林特的 SharePoint 和云播客](http://www.toddklindt.com/blog/default.aspx) | 在本期播客中，Todd Klind 和 Shane Young 讲述了他们在上周作为 SharePoint 管理员和一般多云书呆子所看到的话题。他们还加入了其他与微软相关的技术话题，如 Office 365、PowerShell、SQL Server、Azure，偶尔还会提到 Windows 10 话题。为了把事情搞混，他们会时不时地发布一些小工具评论，甚至可能会发布一两个有趣的猫咪视频。 |
| 

*   Description
    In this podcast, Todd Cleander and Shane Young talk about the topics they saw last week as SharePoint administrators and ordinary cloudy nerds. They also joined other technical topics related to Microsoft, such as Office 365, PowerShell, SQL Server, Azure, and occasionally mentioned the topic of Windows 10\. To get things mixed up, they will post some gadget reviews from time to time, and maybe even post one or two funny cat videos.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/Todd-klindts-SharePoint-and-cloud-podcast/id 318847966？mt=2](https://itunes.apple.com/us/podcast/todd-klindts-sharepoint-and-cloud-podcast/id318847966?mt=2)
...
| 播客标题 | 描述 |
| --- | --- |
| [SQL 数据伙伴](http://sqldatapartners.com/podcast) | 在本播客中，我讨论了各种与 SQL Server 相关的主题，并穿插了一些专业开发，我还与业内一些知名人士进行了交谈。我想引入新的和熟悉的话题，用一种你可能没有考虑过的方式来谈论它们。 |
| 

*   Description
    In this podcast, I discussed various topics related to SQL Server, interspersed with some professional development, and I also talked with some famous people in the industry. I want to introduce new and familiar topics and talk about them in a way that you may not have considered.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/SQL-data-partners-podcast/id 1027394388？mt=2](https://itunes.apple.com/us/podcast/sql-data-partners-podcast/id1027394388?mt=2)

 |
| [SQL Server 广播](http://www.sqlserverradio.com/) | 这是一个播客，面向 SQL Server 数据库管理员、数据库开发人员、架构师、系统管理员以及所有对 Microsoft SQL Server 平台和 Microsoft 数据平台感兴趣的人。我们偶尔也会谈到其他数据平台和服务，如 Azure 和亚马逊云服务、弹性搜索、Hadoop、MongoDB、机器学习等等。 |
| 

*   Description
    This is a podcast for SQL Server database administrators, database developers, architects, system administrators and all those who are interested in Microsoft SQL Server platform and Microsoft data platform. Occasionally, we talk about other data platforms and services, such as Azure and Amazon cloud services, elastic search, Hadoop, MongoDB, machine learning and so on.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/SQL-server-radio/id 907987517？mt=2](https://itunes.apple.com/us/podcast/sql-server-radio/id907987517?mt=2)

 |
| [数据库管理员的播客之声](http://www.voiceofthedba.com/) | Steve 实际上是一名数据库管理员，在数据库开发和数据库维护方面有着丰富的经验。他是一个直言不讳的人。他提出自己的观点，让你质疑在同样的情况下你会怎么做。必须倾听组织中负责数据的任何人。 |
| 

*   Description
    Steve is an actual database administrator with rich experience in database development and maintenance. He is an outspoken man. He put forward his own opinions and made you question what you would do in the same situation. Must listen to anyone in charge of data in the organization.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/edbas 之声-podcast/id 268045050？mt=2](https://itunes.apple.com/us/podcast/voiceofthedbas-podcast/id268045050?mt=2)

 |
| 下的 [SQL Down](http://www.sqldownunder.com/) | 采访世界各地有影响力的 SQL Server 身份 |
| 

*   Description
    Interview with influential SQL Server identities around the world
*   订阅网址
    [https://itunes。苹果。com/us/podcast/SQL-down-under/id 503822116？mt=2](https://itunes.apple.com/us/podcast/sql-down-under/id503822116?mt=2)

 |
| [SQL Server 缓解痛苦](https://www.brentozar.com/) | 办公时间就像是在听病人把他们的 SQL Server 疼痛带到急诊室，医生给出他们的意见。请加入您的主持人、性能调优专家 Brent Ozar 及其高素质的 SQL Server 医疗团队，他们将为您提供一些解决服务器问题的最佳方案。 |
| 

*   Description
    Office hours are like listening to patients bring their SQL Server pain to the emergency room, and doctors give their opinions. Please join Brent Ozar, your host and performance tuning expert, and his high-quality SQL Server medical team, who will provide you with some best solutions to server problems.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/SQL-server-pain-relief-office/id 1070611929？mt=2](https://itunes.apple.com/us/podcast/sql-server-pain-relief-office/id1070611929?mt=2)

 |
| [亲爱的 SQL 数据库管理员](https://www.littlekendra.com/submit-a-dear-dba-question/) | Kendra Little 回答了来自 SQL Server 数据库管理员的紧迫问题—从与 SAN 管理员打交道到处理索引重建，她帮助数据库管理员改进他们的工作。 |
| 

*   Description
    Kendra Little answers the urgent needs of SQL Server database administrators-from dealing with SAN administrators to dealing with index reconstruction, she helps database administrators to improve their work.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/dear-SQL-DBA/id 1117507864？mt=2](https://itunes.apple.com/us/podcast/dear-sql-dba/id1117507864?mt=2)

 |
| [group by-免费 SQL Server 培训](https://groupby.org/) | GroupBy.org 是由社区提供免费技术培训，为社区服务。志愿者演讲者在 GroupBy.org 提交摘要，而你——与会者——投票选择会议。想要展示您自己的会话，还是只是为他人投票？在 GroupBy.org 加入我们。 |
| 

*   Description
    GroupBy.org is a community-oriented free technical training. Volunteers submit abstracts in GroupBy.org, and you, the participants, vote for the meeting. Want to show your own conversation, or just vote for others? Join us in GroupBy.org.
*   订阅网址
    [https://itunes。苹果。com/us/podcast/group by-free-SQL-server-training/id 1196061826？mt=2](https://itunes.apple.com/us/podcast/groupby-free-sql-server-training/id1196061826?mt=2)

 |

哦，如果你正在寻找一个好的播客麦克风设置，我强烈推荐这个防震座的 Podcaster 麦克风。物有所值。